...
if [ -e lib/commons-cli-1.2.jar ]; then
	...
	curl http://www.us.apache.org/dist//commons/cli/binaries/commons-cli-1.2-bin.tar.gz | tar -zxvf - commons-cli-1.2/commons-cli-1.2.jar -O > lib/commons-cli-1.2.jar || \
	(echo "Failed to download ANTLR. Aborting.";rm -f lib/commons-cli-1.2.jar;exit 1)
fi

echo "Type 'make' to compile Protocol Buffer Compiler."
